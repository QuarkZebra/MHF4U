...
const COURSE = {
  ...
  {name:"Polynomial Functions", days:[
    ...
    {d:11, iso:"2026-10-14", topic:"Unit Test", flag:"test", extras:[]},
  ]},

  /* ── UNIT 3 ─────────────────────────────────────────────── */
  {name:"Polynomial Equations & Inequalities", days:[
    {d:1, iso:"2026-10-15", topic:"Solving Polynomial Equations", num:"3.1", note:D("1WylEmcyNZdwCwdfGNMJFou7nwEN1Vpj5"), ans:"" /* key: D("1vgGk1yv2gJbw6J0kwYW8bT-Ed7ObhWcZ") */, extras:[
    ...
    {d:2, iso:"2026-10-16", topic:"Solving Linear Inequalities", num:"3.2", note:D("18HbeDmFAf7ypYxNaMlxlUNP3bs5b9oNB"), ans:"" /* key: D("1xZJC23dpF0l8DJhYBtqdjjxW3lq9lJHu") */, extras:[
    ...
    {d:3, iso:"2026-10-19", topic:"Solving Polynomial Inequalities", num:"3.3", note:D("1Yz0o0ChTUnwUrp0iDHSgY5qVajWZKRgH"), ans:"" /* key: D("1xOhb3W0wfflLmWqbAcnUwdIPQQC7Oxhc") */, extras:[
    ...
    {d:4, iso:"2026-10-20", topic:"Challenge Quiz", flag:"quiz",
    ...
    {d:5, iso:"2026-10-21", topic:"Average Rates of Change", num:"3.4", note:D("1fFcwEQMvImukYrouFZfzavJvZSs22PcF"), ans:"" /* key: D("1XnOJJ5mH1pLn3nMVgDczSZVluuqqO7oF") */, extras:[
    ...
    {d:6, iso:"2026-10-22", topic:"Instantaneous Rates of Change", num:"3.5", note:D("1IMxJnzHKujUAvBAE3VKJERlJ9B9DQflj"), ans:"" /* key: D("10LGI5t_1gI4pC8c4ymcdexGAe8nXTqdF") */, extras:[
      ["Forward Difference on Desmos","https://www.desmos.com/calculator/ckzy8wij4n","doc"],
    ]},
    {d:7, iso:"2026-10-23", topic:"Representing ROC & Graphing", num:"3.6", note:D("1Nw2EJCRdRzc9WtFaoEFDV5kr5Ll25DJ_"), ans:"" /* key: D("1Eez7rGEqkjGuB3-BvfQc3HDhehSg_nWM") */, extras:[
      ["Polynomial Inequalities (with solutions)",D("1PFSZJANtptlcvfcpjYn88cPJsIsEoaA6"),"doc"],
    ]},
    {d:8, iso:"2026-10-26", topic:"Problems Involving ROC", num:"3.7", note:D("1KZ9g64nEQeVFYP_9ERigRbHhQpR9tQGT"), ans:"" /* key: D("1cECWa3wx1ybkylh1R96hPrfleQ75KbgW") */, extras:[
      ["Solving Problems with ROC","https://www.youtube.com/watch?v=4SNAk2fSD58","vid"],
    ]},
    {d:9, iso:"2026-10-27", topic:"ROC in Polynomial Functions", num:"3.8", note:D("1gXvIIepA5MsDnjjJNRPA8XTLcUHKKoVo"), ans:"" /* key: D("1ZJvYO96RAjbX5s3M87Hfg0GuLHgMF2LR") */, extras:[
      ["Extra Question",D("1aBXsRzX4CcE-guWcFp-sip7J8gAH4a_0"),"doc"],
      ["Answers",D("1aC4TJKD2T56iRg7KR7Qjj3yTo4AtPLc8"),"ans"],
    ]},
    {d:10, iso:"2026-10-28", topic:"Review", flag:"review", noteLabel:"Unit Review", ansLabel:"Answers",
    ...
    {d:11, iso:"2026-10-29", topic:"Unit Test", flag:"test", extras:[]},
  ]},

  /* ── UNIT 4 ─────────────────────────────────────────────── */
  {name:"Rational Functions", days:[
    {d:1, iso:"2026-10-30", topic:"Graphs of Reciprocal Functions", num:"4.1", note:D("1v3uYh0ks822Fcu2m5xjxZAGVLksTXGb4"), ans:"" /* key: D("1UBof53_Zraqx8MZKqdxZmfIOsQ8ukrSo") */, extras:[
    ...
    {d:2, iso:"2026-11-02", topic:"Quotients of Polynomials", num:"4.2", note:D("1u9Nq16zcFvx14-wkn29AZP1mskKvoycT"), ans:"" /* key: D("1eCUo0YIJF3nj8sYRuwS1aeXXSLe6vv6V") */, extras:[
    ...
    {d:3, iso:"2026-11-03", topic:"Graphs of Rational Functions", num:"4.3", note:D("1DEeUe-E2jh7d7OWaj4YFpaKBNadu94fh"), ans:"" /* key: D("1U3fMF6QS2l934V7U4-2LCmfRVWOXjV2W") */, extras:[
    ...
    {d:4, iso:"2026-11-04", topic:"Solving Rational Equations", num:"4.4", note:D("123k_oXfImSYXnP7mCd96mv9O3SdRBP2O"), ans:"" /* key: D("1UjxLzPO0X8UtcYNxJgpw0tC0XNLo8Atv") */, extras:[
    ...
    {d:5, iso:"2026-11-05", topic:"Practice Quiz", flag:"quiz",
    ...
    {d:6, iso:"2026-11-06", topic:"Solving Rational Inequalities", num:"4.5", note:D("17lV1ceNe0A1SSiUezlT29zaKCS77oDV2"), ans:"" /* key: D("1Pi4ikNGUpII811Vtj6MoLBtdVfYmnh1R") */, extras:[
    ...
    {d:7, iso:"2026-11-09", topic:"ROC of Rational Functions", num:"4.6", note:D("1BeV9c6pNy4keGAvy5OQEc1W6WyJCENGT"), ans:"" /* key: D("1Aznrwdff0F847zqGImye8wusiKZnukPQ") */, extras:[
      ["Ms. Havrot: Rates of Change in Rational Functions (5.6)","https://www.youtube.com/watch?v=T4GJeS4G9gc","vid"],
    ]},
    {d:8, iso:"2026-11-10", topic:"Review", flag:"review", noteLabel:"Unit Review", ansLabel:"Answers",
    ...
    {d:9, iso:"2026-11-11", topic:"Unit Test", flag:"test", extras:[]},
  ]},

  /* ── UNIT 5 ─────────────────────────────────────────────── */
  {name:"Trigonometric Functions", days:[
    {d:1, iso:"2026-11-12", topic:"Trig Ratios with Radians", num:"5.1", note:D("1cpBf-ZAo3wBeYz_cD_8NmTjRBQkWzQuK"), ans:"" /* key: D("1VJ01PJlASW7IQonyXXCgjID7ktpIcI4b") */ /* v2 draft: note D("1te8V5N0hDsien243k54Km_QQhqe35SRx") key D("1FpF9cPMy814vCkLPAlTXnIhtOTBZ0_yz") */, extras:[
    ...
    {d:2, iso:"2026-11-13", topic:"Graphs of Trig Functions", num:"5.2", note:D("1PQeZqLfoUBYUJqciw9lIuTeAHeZ7XSkj"), ans:"" /* key: D("1XQpDtB3WzBuOT7RByKFLFbiY6QvqsKSH") */, extras:[
    ...
    {d:3, iso:"2026-11-16", topic:"Practice Quiz", flag:"quiz",
    ...
    {d:4, iso:"2026-11-17", topic:"Transformations of Trig Functions", num:"5.3", note:D("1LHPj-C7CJRD72NMhpbGAHUYLQF75pXzK"), ans:"" /* key: D("1AcO7kAsXFy-nvyMq67dPFx1Zq5njHysx") */, extras:[
      ["Graphing Extra Practice (with answers)",D("1R8ytvzOWMppeLJhsje4RBBroGERjIdL5"),"doc"],
    ]},
    {d:5, iso:"2026-11-18", topic:"Reciprocal Trig Functions", num:"5.4", note:D("12xbvlEsXneDTaxFcPfh4fCnJAN9gKHX_"), ans:"" /* key: D("1PLIPXSFCCtClYbfcX2pwl1ASbhq8Zd-F") */, extras:[
    ...
    {d:6, iso:"2026-11-19", topic:"Modelling with Trig Functions", num:"5.5", note:D("1BfMa7IWpbXSLuDuV2Yf9NB2l-uuIMs3R"), ans:"" /* key: D("1-WlIZ94TNAkcbg9BcFyADNKlT5CnXiba") */, extras:[
    ...
    {d:7, iso:"2026-11-20", topic:"Review", flag:"review", noteLabel:"Unit Review", ansLabel:"Answers",
    ...
    {d:8, iso:"2026-11-24", topic:"Trig Rates of Change", num:"5.6", note:D("1WIvfHkdMB0-DS-JCB8KqHr150GWeYfwf"), ans:"" /* key: D("1e4rjqZ_2_I2qwl1Va-LK0GQpRUZs4gbC") */, extras:[
      ["Ms. Havrot: Rates of Change in Trig Functions (6.7)","https://www.youtube.com/watch?v=_wvW1D-EBuQ","vid"],
    ]},
    {d:9, iso:"2026-11-25", topic:"Trig Functions Test (without calculators)", flag:"test", extras:[]},
    {d:10, iso:"2026-11-26", topic:"Trig Functions Test (with calculators)", flag:"test", extras:[]},
  ]},

  /* ── UNIT 6 ─────────────────────────────────────────────── */
  {name:"Trig Identities & Equations", days:[
    {d:1, iso:"2026-11-27", topic:"Trig & Equivalent Functions Review", num:"6.1", note:D("1A3toLNq8yTAbDxIRizPybUdOi1zkMq8r"), ans:"" /* key: D("1Yc0VQhaeeN4uF1NpOBTWt-CQES-oa5Jo") */, extras:[
    ...
    {d:2, iso:"2026-11-30", topic:"Equivalent Trig Functions", num:"6.2", note:D("1ELwi1OrzH0sTgDod8ets-8WqV0jSDlxv"), ans:"" /* key: D("1pORaiLhsfDekXtUmGZhyXSTAbfWVm2Tb") */, extras:[
      ["Lesson Video","https://youtu.be/TyZBzrScTy0","vid"],
    ]},
    {d:3, iso:"2026-12-01", topic:"Compound Angle Formulas", num:"6.3", note:D("1OEooe5ssfaX5nYtddw2CKdRanFwHW0D6"), ans:"" /* key: D("1sNg8aOicWr4-MF0h1kLS9cl3eZeb1-KR") */, extras:[
    ...
    {d:4, iso:"2026-12-02", topic:"Double Angle Formula", num:"6.4", note:D("1U2wjAsyDjIhPXm5KqTjlYSv4IrXLas_k"), ans:"" /* key: D("1DhO0vzkdSt_9E2L-DArnoJDAUCx2wOZw") */, extras:[
      ["Double Angle Identities & Examples","https://www.youtube.com/watch?v=SE5SBTgrwH8","vid"],
    ]},
    {d:5, iso:"2026-12-03", topic:"Practice Quiz", flag:"quiz",
    ...
    {d:6, iso:"2026-12-04", topic:"Proving Trig Identities", num:"6.5", note:D("1Qs4QCd-Cw1YBduSUpx01uYVRpD135657"), ans:"" /* key: D("122Ndao4yP2mlKPYRJf4TQ60FVLI5xSC0") */, extras:[
    ...
    {d:7, iso:"2026-12-07", topic:"Proving Trig Identities II", num:"6.6", note:D("1f_Kq1nVU7L5UB0hKF_4_hUsdIhvKtQi1"), ans:"" /* key: D("1QyOQRE0TpppesZYGsd5OEvdpIcrtBKhe") */, extras:[
    ...
    {d:8, iso:"2026-12-08", topic:"Solving Linear Trig Equations", num:"6.7", note:D("1xW-ARnAbyATAGYQY-d4y6TlbwMaO_-YS"), ans:"" /* key: D("1a-IyCdKuPTSp9TU-Ro6IE91IT_bIlX6S") */, extras:[
      ["Solving Linear Trig Equations","https://www.youtube.com/watch?v=Z2z5zm-sCFE","vid"],
    ]},
    {d:9, iso:"2026-12-09", topic:"Solving Quadratic Trig Equations", num:"6.8", note:D("1SBTGaXhhlp1psDTaLqmUCjJncLOasp9D"), ans:"" /* key: D("1D0INtlTpRHaLohs-0v9O_jNPzzUbmd4M") */, extras:[
      ["Solving Quadratic Trig Equations","https://www.youtube.com/watch?v=NqxLu7E00uE","vid"],
    ]},
    {d:10, iso:"2026-12-10", topic:"Review", flag:"review", noteLabel:"Unit Review", ansLabel:"Answers",
    ...
    {d:11, iso:"2026-12-11", topic:"Review II", flag:"review", note:"", ans:"", extras:[
      ["Ms. Havrot: Chapter 7 Practice Test","https://www.youtube.com/watch?v=Wo06EElyhKw","vid"],
    ]},
    {d:12, iso:"2026-12-14", topic:"Unit Test", flag:"test", extras:[]},
  ]},

  /* ── UNIT 7 ─────────────────────────────────────────────── */
  {name:"Exponentials & Logarithms", days:[
    {d:1, iso:"2026-12-15", topic:"Log Review", num:"7.1", note:D("17g_TdvGCblRGAC7l1xb63KZUgtPXaXLn"), ans:"" /* key: D("1ZQL_FSBBJsillhQZUvsbEYzPEijx1Exb") */, extras:[
    ...
    {d:2, iso:"2026-12-16", topic:"Transformations of Log Functions", num:"7.2", note:D("13GOiPK5boMj3sWbcmcJg4zxp3xS1dkzx"), ans:"" /* key: D("1GbWlKu3l3Wxj8E3eqgRmJCj4eSYyZ-uL") */, extras:[
    ...
    {d:3, iso:"2026-12-17", topic:"Exploring Graphs of Log Functions", num:"7.3", note:"", ans:"", extras:[
    ...
    {d:4, iso:"2026-12-18", topic:"Work Period", note:"", ans:"", extras:[
      ["Old Note: Log Rates of Change",D("1gnuqeN1WbbUjxIX9tLh_tb5tg3sXRIws"),"doc"],
      ["Answers",D("1h7v7Zj_wGTyAIri-PhlrY2ZEmlv88zrA"),"ans"],
    ]},
    {d:5, iso:"2027-01-04", topic:"Evaluating Logs", num:"7.4", note:D("1QfuP6rJMxqeXOHv1qE5UaC7Nxbja21vP"), ans:"" /* key: D("18VPreJkgoufWHNsm6HniWOoSaYBdPBMG") */, extras:[
    ...
    {d:6, iso:"2027-01-05", topic:"Quiz", flag:"quiz",
      noteLabel:"Practice Quiz", ansLabel:"Answers",
    ...
    {d:7, iso:"2027-01-06", topic:"Laws of Logs", num:"7.5", note:D("1_2W01Ch6TbxS6LdQrM51dXQ1-5Shn2qA"), ans:"" /* key: D("1yjfmYTvg2RGK4vlUxTDaZa_44Z-LAizM") */, extras:[
      ["Logarithm Fundamentals","https://www.youtube.com/watch?v=cEvgcoyZvB4","vid"],
    ]},
    {d:8, iso:"2027-01-07", topic:"Solving Exponential Equations", num:"7.6", note:D("1pru8L9Q0bSjRkSCQEmYeHLW8ZjuuRn81"), ans:"" /* key: D("1n_8CGUzH2NO4Zukqu_vtUNqoU3gbYMA9") */, extras:[
    ...
    {d:9, iso:"2027-01-08", topic:"Solving Logarithmic Equations", num:"7.7", note:D("1fBTwREDutzztfmUI0o53y1-5pmV8DRVJ"), ans:"" /* key: D("1Idya7RXInf_3LCldpxtSttUj9xz3Q3U1") */, extras:[
    ...
    {d:10, iso:"2027-01-11", topic:"Work Period", note:"", ans:"", extras:[]},
    {d:11, iso:"2027-01-12", topic:"Solving Problems with Log & Exp Functions", num:"7.8", note:D("18T8fp54x1aOBlmrjpGQNC_25DMnNEKLm"), ans:"" /* key: D("1PxdOQAmMqVg2X9atSYlPMFWv6DV_esMN") */, extras:[
      ["Extra Word Problems",D("1gYzFpvAb-EpoETfuOBKKMdGAGuzYaWt9"),"doc"],
    ]},
    {d:12, iso:"2027-01-13", topic:"Combining, Changing & Modelling with Log/Exp", num:"7.9", note:D("11DRJooLSkD4IV3elQna5Rxqf2SILXVrr"), ans:"" /* key: D("10_v64nKqmEeg8YS4q_ax6k0WKYId_-4K") */, extras:[
      ["Desmos Gas Model (from class)","https://www.desmos.com/calculator/q7zzmwdqy1","doc"],
    ]},
    {d:13, iso:"2027-01-14", topic:"Review", flag:"review", noteLabel:"Unit Review", ansLabel:"Answers",
    ...
    {d:14, iso:"2027-01-15", topic:"Unit Test", flag:"test", extras:[]},
  ]},
